...
trait HasPermissions
{
     ...
     */
    public function getPermissionsOnPlace($place_id): Collection
    {
        $permissions = $this->permissions;

        return $permissions->merge($this->load('roles', 'roles.permissions')
            ->roles->flatMap(function ($role) use ($place_id) {
